...
import { Copter } from "./Examples/copter.js";
import { Train } from "./Examples/train.js";
import { TrainTrack } from "./Examples/traintrack.js";
import { UFO } from "./Examples/ufo.js";
import { Basketball } from "./Examples/basketball.js";
...
function grtown() {
    ...
    let quad = new Copter();
    let train = new Train();
    let trainTrack = new TrainTrack()
    let ufo = new UFO();
    let ball = new Basketball();
